...
const WHATSAPP_NUMBER = '5571991333879'

export default function Contact() {
  function openWhatsApp() {
    const msg = encodeURIComponent('Olá! Vim pelo FinDash e gostaria de falar com o desenvolvedor.')
    ...
    <div className="space-y-6 animate-fade-in max-w-xl">
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-gray-400 mt-1">
          Dúvidas, sugestões ou problemas? Fale diretamente com o desenvolvedor.
        </p>
      </div>
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="font-bold text-slate-900 dark:text-white text-lg">Desenvolvedor FinDash</p>
            <p className="text-sm text-slate-500 dark:text-gray-400">Suporte & Feedbacks</p>
          </div>
        </div>
